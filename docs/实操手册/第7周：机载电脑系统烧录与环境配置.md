...
<strong>​​​💡 实践准备：<br>
准备香橙派底板，电脑预先准备 Ubuntu 系统镜像与烧录工具；香橙派完成系统烧录后需能够正常上电联网。
...
<strong>​​​💡 下载地址：香橙派官方网站: <a href="https://www.orangepi.cn">https://www.orangepi.cn</a>
...
<div style="background-color: #f1f1d1ff; border-left: 8px solid #b9b625ff; padding: 10px 15px; margin: 15px 0; border-radius: 3px;">
<strong>​​​💡 注意：进入MASKROM模式前必须移除风扇接口，否则可能无法正常进入烧录模式。
...
<div style="background-color: #f1f1d1ff; border-left: 8px solid #b9b625ff; padding: 10px 15px; margin: 15px 0; border-radius: 3px;">
<strong>​​​💡 注意：烧录过程中切勿断电或拔插USB线，否则可能导致系统损坏或开发板变砖。
...
2. 安装 plotjuggler、terminator、vrpn 等常用调试工具

3. 创建 Eigen 库的软链接，解决编译时头文件找不到的问题

4. 将主机名 minicore 映射到 127.0.0.1，避免 ROS 网络配置报错
...
<div style="background-color: #f1f1d1ff; border-left: 8px solid #b9b625ff; padding: 10px 15px; margin: 15px 0; border-radius: 3px;">
<strong>​​​💡 说明：使用 fishros 一键安装脚本可以自动配置软件源、安装 ROS Noetic 版本，并完成环境变量配置，省去手动配置的繁琐步骤。
</strong>
</div>
...
<strong>​​​💡 验证：如果命令返回 mavros 包的安装路径（如 /opt/ros/noetic/share/mavros），说明安装成功。
</strong>
</div>
...
<div style="background-color: #f1f1d1ff; border-left: 7px solid #b9b625ff; padding: 10px 15px; margin: 15px 0; border-radius: 3px;">
<strong>​​​💡 快捷键：Ctrl+Shift+E 垂直分割，Ctrl+Shift+O 水平分割，Ctrl+Shift+W 关闭当前终端。
</strong>
</div>
...
<div style="background-color: #f1f1d1ff; border-left: 7px solid #b9b625ff; padding: 10px 15px; margin: 15px 0; border-radius: 3px;">
<strong>​​​💡 提示：PlotJuggler 支持同时绘制多个话题的数据，可以对比分析不同传感器的输出。
</strong>
</div>
...
<div style="background-color: #f1f1d1ff; border-left: 7px solid #b9b625ff; padding: 10px 15px; margin: 15px 0; border-radius: 3px;">
<strong>​​​💡 提示：rqt 可以同时打开多个插件窗口，灵活布局，适合复杂的ROS系统调试。
</strong>
</div>
...
<div style="background-color: #f1f1d1ff; border-left: 7px solid #b9b625ff; padding: 10px 15px; margin: 15px 0; border-radius: 3px;">
    <strong>​​​💡 
    注意：端口号需要根据实际连接的串口设备进行配置，可以使用 ls /dev/ttyUSB* 或 s /dev/ttyACM* 查看设备名称。
    </strong>
</div>
...
<div style="background-color: #f1f1d1ff; border-left: 7px solid #b9b625ff; padding: 10px 15px; margin: 15px 0; border-radius: 3px;">
    <strong>​​​💡 
    验证标准：正常情况下 IMU 数据发布频率约为 30\-50Hz，如果显示 "no new messages" 或频率为 0，说明通信未建立，需要检查串口配置和接线。
    </strong>
</div>
...
<div style="background-color: #f1f1d1ff; border-left: 7px solid #b9b625ff; padding: 10px 15px; margin: 15px 0; border-radius: 3px;">
    <strong>​​​💡 
    验证：如果终端持续输出不断更新的数值，说明 MAVROS 与 PX4 飞控通讯正常，传感器数据正在实时上传。
    </strong>
</div>
